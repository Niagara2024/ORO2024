      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Text('IMEI: ${device.imeiNumber}', style: TextStyle(fontSize: 12,color: Colors.black87)),
              Text('Area: ${device.areaName}', style: TextStyle(fontSize: 12,color: Colors.black87))
            ],
          ),
        );
      },
