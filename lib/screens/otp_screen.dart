                  ...
                  SafeArea(
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Text('VERIFY PHONE', style: Theme.of(context).textTheme.titleLarge,),
                          ...
                          Pinput(
                            defaultPinTheme: PinTheme(
                                textStyle: TextStyle(fontFamily: GoogleFonts.poppins().fontFamily, fontWeight: FontWeight.bold, fontSize: 18),
